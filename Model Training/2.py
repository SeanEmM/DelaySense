...
flight_data = df.iloc[50000:100000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather2.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather2.csv')
