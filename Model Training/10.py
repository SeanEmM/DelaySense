...
flight_data = df.iloc[450000:500000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather.csv10')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather10.csv')
