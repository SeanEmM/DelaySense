...
flight_data = df.iloc[400000:450000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather9.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather9.csv')
