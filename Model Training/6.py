...
flight_data = df.iloc[250000:300000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather6.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather6.csv')
