...
flight_data = df.iloc[200000:250000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather5.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather5.csv')
