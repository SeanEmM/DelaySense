...
flight_data = df.iloc[100000:150000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather3.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather3.csv')
