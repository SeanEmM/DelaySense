...
flight_data = df.iloc[350000:400000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather8.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather8.csv')
