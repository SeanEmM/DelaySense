...
flight_data = df.iloc[300000:350000,:]
...
departure_weather = batch_fetch_weather(unique_origin, 'departure_weather7.csv')
arrival_weather = batch_fetch_weather(unique_dest, 'arrival_weather7.csv')
